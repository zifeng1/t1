                       ...
                       <li class="nav-item dropdown">
                           <a href="" class="nav-link dropdown-toggle" id="navbar-drop" data-toggle="dropdown">
                               ...
                               <div class="dropdown-menu">
                                   <a href="products.php#watch" class="dropdown-item">Flower</a>
                                   <a href="products.php#shirt" class="dropdown-item">Cake</a>
                                   <a href="products.php#shoes" class="dropdown-item">Bear</a>
                                   <a href="products.php#headphones" class="dropdown-item">Chocolate</a>
                               </div>
